...
const Hero = () => {
  ...
  const ClientComponent = () => {
    ...
    return null; // You can return anything here as needed
  };
      ...
      <div className="max-w-[1320px] xl:my-[120px] my-20 mx-auto flex flex-col gap-6 px-4">
        <div className="flex md:flex-row flex-col gap-8">
          <div className="flex gap-4 items-center ">
            <label
              htmlFor="sort"
              className="text-[#333333] text-[20px] font-normal leading-7 whitespace-nowrap"
            >
              Sort by:
            </label>
            <div className="relative flex w-full">
              <select
                id="sort"
                className="border border-[#E0E0E0] text-[#BDBDBD] w-full md:w-[236px] font-inter font-normal text-lg py-1 sm:py-[10px] px-6"
              >
          ...
          <div className="flex gap-4 items-center ">
            ...
            <div className="relative flex w-full">
              <select
                id="sort"
                className="border border-[#E0E0E0] text-[#BDBDBD] font-inter w-full md:w-[236px] font-normal text-lg py-1 sm:py-[10px] px-6"
              >
        ...
        <div className="relative md:hidden">
          <input
            ...
            className="w-full bg-pink-50 font-inter text-base font-normal py-3 px-4 outline-none"
        ...
        <div className="flex mt-6 gap-6 justify-between">
          ...
          <div className="w-full flex flex-col items-center justify-center gap-14">
            {filteredProducts.length === 0 ? (
              <div>
                <p className="text-center text-6xl text-primary">
                  Items not Found
                </p>
              </div>
            ) : (
